...
public class MainFragment extends Fragment implements View.OnClickListener, Handler.Callback {
    ...
    private void initConnection() {
        mConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                ...
                Log.d("svcom", "onServiceConnected");
            ...
            public void onServiceDisconnected(ComponentName className) {
                ...
                Log.d("svcom", "onServiceDisconnected");
                mService = null;
    ...
    {
        try {
            InputStream conf = getActivity().getAssets().open("sv.conf");
...
//    };
    ...
    private void bindService() {
        ...
        Log.d("svcom", "bindService");
        getActivity().bindService(icsopenvpnService, mConnection, Context.BIND_IMPORTANT);
    }
